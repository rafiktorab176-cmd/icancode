...
// Dynamic Schema Injection for Unionaire Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على unionaire أو union-aire
  if (path.includes("unionaire") || path.includes("union-aire")) {
    const unionaireSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/unionaire/#service",
          name: "المركز المعتمد لصيانة يونيون اير في مصر",
          serviceType: "Appliance Repair Service",
          brand: {
            "@type": "Brand",
            name: "Unionaire",
            alternateName: "يونيون اير",
          },
          provider: {
            "@type": "LocalBusiness",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة يونيون اير",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة تكييفات وشاشات يونيون اير بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال ثلاجات وغسالات وشاشات يونيون اير",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/unionaire/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة يونيون اير | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(unionaireSchema);
