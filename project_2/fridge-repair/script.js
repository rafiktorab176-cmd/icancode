...
// Dynamic Schema Injection for Refrigerators Repair Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على fridge أو fridges أو refrigerator
  if (path.includes("fridge") || path.includes("refrigerator")) {
    const fridgeSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/refrigerators-repair/#service",
          name: "المركز المعتمد لصيانة الثلاجات بمصر",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أعطال الثلاجات",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "شحن فريون وفحص الموتور والكباس للثلاجات",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح تسريب المياه وأعطال النوفروست والديفروست",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/refrigerators-repair/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة الثلاجات والغسالات والديب فريزر | التلاجات | 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(fridgeSchema);
