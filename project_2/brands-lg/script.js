...
// Dynamic Schema Injection for LG Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على lg
  if (path.includes("lg")) {
    const lgSchema = {
      ...
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/lg/#service",
          name: "المركز المعتمد لصيانة إل جي في مصر",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة إل جي",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة غسالات وشاشات وثلاجات إل جي بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال غسالات الأطباق ومجففات وديب فريزر LG",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/lg/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة الجي | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(lgSchema);
