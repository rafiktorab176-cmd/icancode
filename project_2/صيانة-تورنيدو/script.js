...
// Dynamic Schema Injection for Tornado Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على tornado
  if (path.includes("tornado")) {
    const tornadoSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/tornado/#service",
          name: "المركز المعتمد لصيانة تورنيدو في مصر",
          serviceType: "Appliance Repair Service",
          brand: {
            "@type": "Brand",
            name: "Tornado",
            alternateName: "تورنيدو",
          },
          provider: {
            "@type": "LocalBusiness",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة تورنيدو",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة شاشات وثلاجات وغسالات تورنيدو بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال سخانات ومراوح وشاشات تورنيدو العربي",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/tornado/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة تورنيدو | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(tornadoSchema);
