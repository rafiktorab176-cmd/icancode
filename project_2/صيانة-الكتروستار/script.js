...
// Dynamic Schema Injection for Electrostar Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على electrostar أو electro-star
  if (path.includes("electrostar") || path.includes("electro-star")) {
    const electrostarSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/electrostar/#service",
          name: "المركز المعتمد لصيانة إلكتروستار في مصر",
          serviceType: "Appliance Repair Service",
          brand: {
            "@type": "Brand",
            name: "Electrostar",
            alternateName: "إلكتروستار",
          },
          provider: {
            "@type": "LocalBusiness",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة إلكتروستار",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة ديب فريزر وثلاجات إلكتروستار بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال غسالات وبوتاجازات إلكتروستار",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/electrostar/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة الكتروستار | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(electrostarSchema);
