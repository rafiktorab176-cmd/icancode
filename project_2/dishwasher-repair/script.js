...
// Dynamic Schema Injection for Dishwasher Repair Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على dishwasher أو dishwashers
  if (path.includes("dishwasher") || path.includes("dishwashers")) {
    const dishwasherSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/dishwasher-repair/#service",
          name: "المركز المعتمد لصيانة غسالات الأطباق بمصر",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أعطال غسالات الأطباق",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح ومُعالجة تسريبات المياه وأعطال طلمبة السحب والتصريف",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة رشاشات المياه والسخانات وكارتات التحكم لغسالات الصحون",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/dishwasher-repair/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة الثلاجات والغسالات والديب فريزر | غسالات الاطباق | 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(dishwasherSchema);
