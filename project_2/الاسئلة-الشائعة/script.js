document.addEventListener("DOMContentLoaded", () => {
  ...
  // 5. قائمة الأكورديون للأسئلة الشائعة (FAQ Accordion)
  ...
  // 6. التبديل بين ألسنة الأسئلة (FAQ Tabs)
  ...
  // 7. التبديل بين ألسنة الشروط والسياسات (Legal Tabs)
...
// 8. الحماية والمنع (Right-Click & DevTools Shortcuts)
