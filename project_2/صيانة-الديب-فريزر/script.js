...
// Dynamic Schema Injection for Deep Freezer Repair Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على freezer أو deep-freezer
  if (path.includes("freezer") || path.includes("deep-freezer")) {
    const freezerSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/deep-freezer-repair/#service",
          name: "المركز المعتمد لصيانة الديب فريزر بمصر",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أعطال الديب فريزر",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة وإصلاح أعطال التجميد وتسريب الفريون للديب فريزر",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "تغيير الثرموستات والكباس ومراوح التبريد النوفروست",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/deep-freezer-repair/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة الثلاجات والغسالات والديب فريزر | ديب فريزر | 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(freezerSchema);
