...
// Dynamic Schema Injection for Ariston Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على ariston
  if (path.includes("ariston")) {
    const aristonSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/ariston/#service",
          name: "المركز المعتمد لصيانة أريستون في مصر",
          serviceType: "Appliance Repair Service",
          brand: {
            "@type": "Brand",
            name: "Ariston",
            alternateName: "أريستون",
          },
          provider: {
            "@type": "LocalBusiness",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة أريستون",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة غسالات أطباق وملابس وسخانات أريستون بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال ثلاجات وبوتاجازات ومجففات أريستون",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/ariston/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة اريستون | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(aristonSchema);
