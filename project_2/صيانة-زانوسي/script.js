...
// Dynamic Schema Injection for Zanussi Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على zanussi
  if (path.includes("zanussi")) {
    const zanussiSchema = {
      "@context": "https://schema.org",
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/zanussi/#service",
          name: "المركز المعتمد لصيانة زانوسي في مصر",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة زانوسي",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة غسالات وثلاجات زانوسي بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال ديب فريزر وغسالات أطباق زانوسي",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/zanussi/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة زانوسي | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(zanussiSchema);
