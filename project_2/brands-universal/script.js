...
// Dynamic Schema Injection for Universal Maintenance Page
document.addEventListener("DOMContentLoaded", function () {
  const path = window.location.pathname;

  // يتم التفعيل إذا كان رابط الصفحة يحتوي على universal
  if (path.includes("universal")) {
    const universalSchema = {
      ...
      "@graph": [
        {
          "@type": "Service",
          "@id": "https://hotline-19580.com/universal/#service",
          name: "المركز المعتمد لصيانة يونيفرسال في مصر",
          serviceType: "Appliance Repair Service",
          brand: {
            "@type": "Brand",
            name: "Universal",
            alternateName: "يونيفرسال",
          },
          provider: {
            "@type": "LocalBusiness",
          ...
          hasOfferCatalog: {
            "@type": "OfferCatalog",
            name: "خدمات صيانة أجهزة يونيفرسال",
            itemListElement: [
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "صيانة بوتاجازات وسخانات يونيفرسال بقطع غيار أصلية",
                },
              },
              {
                "@type": "Offer",
                itemOffered: {
                  "@type": "Service",
                  name: "إصلاح أعطال غسالات وثلاجات يونيفرسال",
                },
              },
            ],
          },
        ...
        {
          "@type": "WebPage",
          "@id": "https://hotline-19580.com/universal/#webpage",
          url: window.location.href,
          name: "المركز المعتمد لصيانة يونيفرسال | ارقام الخدمة 19580 - 17718 - 15607",
          inLanguage: "ar",
        },
      ],
    };
    ...
    script.text = JSON.stringify(universalSchema);
